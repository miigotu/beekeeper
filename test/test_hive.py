...
hive_v5 = {"name": "test_hive", "versioning": {"version": 5, "other_versions": [{"version": 4, "location": "url_for_version_4"}]}}

hive_v4 = {"name": "test_hive", "versioning": {"version": 4, "other_versions": [{"version": 5, "location": "url_for_version_5"}]}}
...
def fake_download_as_json(url):
    hives = {"url_for_version_4": hive_v4, "url_for_version_5": hive_v5}
    return hives[url]
...
class HiveTest(unittest.TestCase):
    ...
    def test_other_versions(self):
        self.assertEqual(self.hive.other_versions(), [{"version": 4, "location": "url_for_version_4"}])

    def test_from_version(self):
        self.assertEqual(self.hive.from_version(4), beekeeper.hive.Hive(**hive_v4))
    ...
    def test_from_empty_version(self):
        self.assertEqual(self.hive.from_version(None), self.hive)

    def test_from_same_version(self):
        self.assertEqual(self.hive.from_version(5), self.hive)
