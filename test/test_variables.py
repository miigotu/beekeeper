...
from beekeeper.variables import merge, Variable, Variables

variable_1 = Variable("type", **{"value": "value1", "mimetype": "mimetype1", "types": ["type1_1", "type1_2"], "optional": True})
variable_2 = Variable("type", **{"value": "value2", "mimetype": "mimetype2", "types": ["type2_1"], "optional": False})
variable_3 = {}
variable_4 = {"value": "whatever"}


class VariableTest(unittest.TestCase):
    def test_merge(self):
        result1 = Variable(
            "type", **{"value": "value1", "mimetype": "mimetype1", "types": ["type1_1", "type1_2", "type2_1"], "optional": True, "filename": None}
        )
        result2 = Variable(
            "type", **{"value": "value2", "mimetype": "mimetype2", "types": ["type2_1", "type1_1", "type1_2"], "optional": False, "filename": None}
        )
    ...
    def test_create_with_single_type(self):
        x = Variable("type", **{"value": "value2", "mimetype": "mimetype2", "type": "type2_1", "optional": False})
